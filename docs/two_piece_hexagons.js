...
(function( root, factory ) {
    if( typeof define === "function" && define.amd ) {
        ...
        Rust.two_piece_hexagons = factory();
    }
}( this, function() {
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "two_piece_hexagons.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "two_piece_hexagons.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'two_piece_hexagons'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'two_piece_hexagons':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_23d67c564bd8791d3f2c383f84226936ac33ecb6": function($0, $1, $2, $3, $4) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);$4 = Module.STDWEB_PRIVATE.to_js($4);Module.STDWEB_PRIVATE.from_js($0, (function(){var h={};var canvas=($1);h.gl=($2);if(! h.gl){console.log("No WebGL; using Canvas API");var new_canvas=canvas.cloneNode(true);canvas.parentNode.replaceChild(new_canvas,canvas);canvas=new_canvas;h.ctx=canvas.getContext("2d");h.img=h.ctx.createImageData(($3),($4));h.buffer=new Uint32Array(h.img.data.buffer);}return h;})());
            },
            ...
            "__cargo_web_snippet_72ae0ffa6ce71ac2dacb44f7eef0d9640437337c": function($0, $1, $2, $3, $4) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);$4 = Module.STDWEB_PRIVATE.to_js($4);Module.STDWEB_PRIVATE.from_js($0, (function(){var h=($1);var framebuffer=($2);if(h.gl){var data=new Uint8Array(framebuffer.buffer,framebuffer.byteOffset,framebuffer.byteLength);h.gl.texSubImage2D(h.gl.TEXTURE_2D,0,0,0,($3),($4),h.gl.RGBA,h.gl.UNSIGNED_BYTE,data);h.gl.drawElements(h.gl.TRIANGLES,6,h.gl.UNSIGNED_SHORT,0);}else{h.buffer.set(framebuffer);h.ctx.putImageData(h.img,0,0);}})());
            },
            ...
            "__cargo_web_snippet_dd0639efb2f98b86c1818d320bc303a11d494a28": function($0, $1) {
